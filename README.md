...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flake8-eradicate-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12500&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flake8-eradicate-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flake8-eradicate` can be installed with:

```
conda install flake8-eradicate
```

It is possible to list all of the versions of `flake8-eradicate` available on your platform with:
